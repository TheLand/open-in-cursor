...
- First-launch guide for macOS Gatekeeper with **Open Privacy & Security** when the app quarantine flag is present.

### Changed

- README: dedicated **First launch (macOS security)** section with Right-click → Open, Settings, and Terminal workarounds.
- Development docs: distribution limitations for unsigned/unnotarized releases.
...
[Unreleased]: https://github.com/TheLand/open-in-cursor/compare/v1.0.2...HEAD
